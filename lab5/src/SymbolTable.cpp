...
SymbolTable::SymbolTable()
{
    ...
    level = 0;
    // 添加运行时库
    IntType *intType = new IntType(32, false);
    FloatType *floatType = new FloatType(32, false);
    VoidType *voidType = new VoidType();
    // ArrayType *intArrType = new ArrayType(intType, -1);
    // ArrayType *floatArrType = new ArrayType(floatType, -1);
    PointerType *intPtrType = new PointerType(intType);
    PointerType *floatPtrType = new PointerType(floatType);

    Type *none2intType = new FunctionType(intType, {});
    Type *intArr2intType = new FunctionType(intType, {intPtrType});
    Type *none2floatType = new FunctionType(floatType, {});
    Type *floatArr2intType = new FunctionType(intType, {floatPtrType});
    Type *int2voidType = new FunctionType(voidType, {intType});
    Type *intXintArr2voidType = new FunctionType(voidType, {intType, intPtrType});
    Type *float2voidType = new FunctionType(voidType, {floatType});
    Type *intXfloatArr2voidType = new FunctionType(voidType, {intType, floatPtrType});
